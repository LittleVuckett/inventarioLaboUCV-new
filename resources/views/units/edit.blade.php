            ...
            <div class="col-xl-12">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <!-- Form Group (name) -->
                        <div class="mb-3">
                            <label class="small mb-1" for="name">Nombre de Ambiente<span class="text-danger">*</span></label>
                        ...
                        <!-- Form Group (slug) -->
                        <div class="mb-3">
                            <label class="small mb-1" for="slug">cod Ambiente</label>
                        ...
                        <a class="btn btn-danger" href="{{ route('units.index') }}">Cancelar</a>
                    </div>
                </div>
                <!-- END: Unit Details -->
            </div>
