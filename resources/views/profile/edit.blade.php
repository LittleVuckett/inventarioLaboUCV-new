...
<div class="container-xl px-4 mt-4">
    ...
    <nav class="nav nav-borders">
        <a class="nav-link active ms-0" href="{{ route('profile.edit') }}">Usuario</a>
        <a class="nav-link" href="{{ route('profile.settings') }}">Configuración</a>
    </nav>
            ...
            <div class="col-xl-4">
                ...
                <div class="card mb-4 mb-xl-0">
                    ...
                    <div class="card-body text-center">
                        ...
                        <div class="small font-italic text-muted mb-2">JPG ó PNG de no más de 1mb </div>
